package com.princeabdurrahman.covidapp.Adapter
...
import com.princeabdurrahman.covidapp.R
...
class CountryAdapter (
    ...
    class ViewHolder(itemView:View) :RecyclerView.ViewHolder(itemView) {
        fun bind(negara: Negara, clickListener: (Negara) -> Unit){
            ...
            val cTotalDeaths: TextView = itemView.country_total_death
            val flag:CircleImageView = itemView.img_flag_circle

            val formatter: NumberFormat = DecimalFormat("#,###")

            country.countryName.text = negara.Country
            cTotalCase.country_total_cases.text = formatter.format(negara.TotalConfirmed?.toDouble())
            cTotalRecovered.country_total_recovered.text =
                formatter.format(negara.TotalRecovered?.toDouble())
            cTotalDeaths.country_total_death.text =
