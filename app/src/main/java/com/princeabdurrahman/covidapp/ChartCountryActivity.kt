package com.princeabdurrahman.covidapp
...
import com.princeabdurrahman.covidapp.Network.InfoService
...
class ChartCountryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        data?.let {
            ...
            hasil_total_recovery_currently.text = formatter.format(data.TotalRecovered?.toDouble())
            hasil_new_recovery_currently.text = formatter.format(data.NewRecovered?.toDouble())
            ...
            if (simpanFlag != null){
                Glide.with(this)
                    .load("https://www.countryflags.io/$simpanDataFlag")
